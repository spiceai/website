...
export const UseCase = ({ useCaseData }: { useCaseData: UseCaseData }) => {
  return (
    <a
      ...
      className='group flex h-[368px] flex-col items-start justify-between gap-6 rounded-sm border border-alpha-150 bg-neutral px-10 py-14 transition-colors hover:bg-neutral hover:shadow-box lg:h-auto lg:bg-transparent'
    >
      <div>
