...
export const Article = ({ articleData }: { articleData: ArticleData }) => {
  return (
    <article className='group relative overflow-hidden rounded-lg bg-neutral p-4 shadow-card-shadow transition-all md:bg-transparent md:shadow-none md:hover:bg-neutral md:hover:drop-shadow-sm'>
