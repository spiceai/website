...
export const Cta = () => {
  return (
    <div className='my-20 flex flex-col overflow-hidden rounded-2xl lg:flex-row'>
      ...
      <div className='flex flex-col justify-between gap-6 bg-alpha-800 px-8 py-16 md:p-14 lg:w-5/12 xl:p-20'>
        ...
        <div className='flex items-start justify-between gap-5'>
          <div className='flex flex-col gap-2'>
            ...
            <Image src='/eigen-layer.png' alt='EigenLayer' width={44} height={44} />
          </div>
          <Image src='/kannan.png' alt='Kannan' width={70} height={70} />
        </div>
      </div>
    </div>
  )
